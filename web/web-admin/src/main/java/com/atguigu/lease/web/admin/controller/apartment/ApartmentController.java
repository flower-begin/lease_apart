...
public class ApartmentController {
    ...
    public Result saveOrUpdate(@RequestBody ApartmentSubmitVo apartmentSubmitVo) {
        apartmentInfoService.customUpdateOrSave(apartmentSubmitVo);
        return Result.ok();
    }
    ...
    public Result<IPage<ApartmentItemVo>> pageItem(@RequestParam long current, @RequestParam long size, ApartmentQueryVo queryVo) {
        ...
        apartmentInfoService.customPage(queryVo, page);
    ...
    public Result<ApartmentDetailVo> getDetailById(@RequestParam Long id) {
        ApartmentDetailVo apartmentDetailVo = apartmentInfoService.customGetById(id);
    ...
    public Result removeById(@RequestParam Long id) {
        apartmentInfoService.coustomRemoveById(id);
        return Result.ok();
    }
    ...
    public Result<List<ApartmentInfo>> listInfoByDistrictId(@RequestParam Long id) {
        ...
        // ApartmentInfo有字段区域id,所以这个接口就是进行单表查询
